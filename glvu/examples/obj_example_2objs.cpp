...
int main(int argc, char *argv[])
{
  ...
  glvu.Init("GLVU 2 Objects Example",
  ...
  Objs[0] = new ObjModel("models/obj/al.obj");
  Objs[1] = new TriModel("models/tri/tie.tri");

  Vec3f m=Objs[0]->Min, M=Objs[0]->Max, LookAtCntr=(m+M)*0.5;
