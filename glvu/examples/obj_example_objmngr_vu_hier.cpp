//------------------------------------------------------------------------------
// File : obj_example_objmngr_vu_hier.cpp
//------------------------------------------------------------------------------
      ...
      if (SelectedObj>=0)
      {
        ...
        if (glutGetModifiers() & (GLUT_ACTIVE_CTRL)) {
          for (int i = 0; i < OM->NumObjInstances; i++) {
            if (OM->IsAlreadySelected(i)) {
              OM->ObjInstances[i]->DetachChild(OM->ObjInstances[SelectedObj]);
          ...
          // want to attach this object to the other
          for (int i = 0; i < OM->NumObjInstances; i++) {
            if (OM->IsAlreadySelected(i)) {
              OM->ObjInstances[i]->AttachChild(OM->ObjInstances[SelectedObj]);
              break;
            }
          }
        }
