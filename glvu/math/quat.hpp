...
public:
  ...
  // Note if you're going to batch transform more than one vec, 
  // you're better off using ToMat first and transforming with mat-vec mults.
  // Xform is 26 mults.  ToMat is 17 and and each mat-vec is 9.
  // Quat-quat mults, on the other hand are cheaper than mat-mat
  // (12 mults vs 27 mults)
