...
// From the Siggraph OGL Advanced Rendering Source Code
...
static ImageRec *ImageOpen(const char *fileName)
{
    ...
    if (image == NULL) {
	fprintf(stderr, "RGB ERROR (ImageOpen): Out of memory!\n");
	exit(1);
    }
...
void
readRGBfile(const char *name, unsigned char **texData, int *width, int *height, 
            int *components) 
{
    unsigned *base,*lptr;
