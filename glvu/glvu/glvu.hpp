...
class GLVU
{
  public:
    ...
    void GetPixelRay(int sx, int sy, int ww, int wh, Vec3f *Start, Vec3f *Dir)
      const;
 ...
 * @see SetWorldNavMode
 */
inline const Vec3f& GLVU::GetViewUp() const 
{
  return(ViewUp); 
}
 ...
 */
inline const Vec3f& GLVU::GetWorldCenter() const 
{
  return WorldCenter; 
}
 ...
 */
inline void GLVU::SetWorldCenter(const Vec3f& center)
{
  WorldCenter = center;
}
 ...
 * @see GetViewUp
 */
inline void GLVU::SetViewUp(Vec3f viewup) 
{
  ViewUp=viewup; 
}
